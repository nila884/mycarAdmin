...
import BrandForm from '@/components/car/settings/brand/brandForm';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <CarSettingLayout>
                <div className="space-y-6">
                    ...
                    <Table className="min-w-2xl rounded-md border">
                            ...
                            {brands.length > 0 ? (
                                brands.map((brand) => (
                                    <TableRow key={brand.id}>
                                        <TableCell>
                                            <img src={brand.logo} alt={brand.brand_name} className="h-10 w-10 rounded object-cover" />
                                        </TableCell>
                                        ...
                                        <TableCell className="text-right">
                                            ...
                                            <Button className="ml-2" size="icon" variant="destructive" onClick={() => handleDelete(brand.id)}>
                                                <X />
                                            </Button>
                                        </TableCell>
                                    </TableRow>
