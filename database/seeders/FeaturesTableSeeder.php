...
use App\Models\Feature; // Import your Feature model
...
class FeaturesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($features as $featureData) {
            // Use firstOrCreate to prevent duplicates based on 'feature_name'.
            // If a feature with the given 'feature_name' already exists, it will be retrieved.
            // Otherwise, a new record will be created, and its 'id' will be auto-generated.
            Feature::firstOrCreate(
                ['feature_name' => $featureData['feature_name']], // Attributes to find by
                [
